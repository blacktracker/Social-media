...
export const TikTokIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-2.43.05-4.86-.95-6.69-2.81-1.75-1.76-2.59-4.18-2.6-6.6-.01-2.8.95-5.59 2.81-7.38 1.94-1.89 4.81-2.79 7.37-2.79.02 2.87-.01 5.74.02 8.61.15 2.08 2.02 3.84 4.09 4.18 2.05.34 4.16-.64 5.31-2.22.2-.28.36-.59.51-.91-2.09-.12-4.19-.57-6.23-1.4v-4.18c2.18.81 4.49 1.11 6.72 1.01V9.74c-2.18-.01-4.36.21-6.52.73V.02z" />
    </svg>
);
...
export const PinterestIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 0C5.373 0 0 5.373 0 12c0 5.104 3.163 9.426 7.502 11.235-.05-.487-.091-1.284.02-1.82.128-.63.832-3.535.832-3.535s-.212-.423-.212-1.046c0-.98.57-1.713 1.28-1.713.606 0 .894.454.894 1.003 0 .61-.387 1.516-.588 2.356-.164.69.347 1.255.99 1.255 1.187 0 2.095-1.264 2.095-3.085 0-1.614-1.155-2.73-2.62-2.73-1.83 0-2.923 1.37-2.923 2.823 0 .34.11.71.254.915.03.04.03.07.02.11-.02.08-.06.21-.08.28-.02.08-.08.1-.13.04-1.002-.51-1.63-2.03-1.63-3.235 0-2.32 1.75-4.444 4.88-4.444 2.57 0 4.54 1.82 4.54 4.254 0 2.54-1.62 4.58-3.87 4.58-1.01 0-1.96-.525-2.29-1.144 0 0-.48 1.92-.59 2.32-.205.77-.39 1.48-.56 2.05.65.21 1.33.32 2.03.32 6.627 0 12-5.373 12-12S18.627 0 12 0z" />
    </svg>
);
...
export const EngagementIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 3L9.5 8.5L4 10l5.5 4.5L8 21l4-4.5L16 21l-1.5-6.5L20 10l-5.5-1.5z"/>
        <path d="M22 2L20 4"/>
        <path d="M2 22l2-2"/>
        <path d="M2 2l2 2"/>
        <path d="M22 22l-2-2"/>
...
export const UndoIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 10h10a8 8 0 0 1 8 8v2M3 10l4-4 4 4"/>
    </svg>
);
